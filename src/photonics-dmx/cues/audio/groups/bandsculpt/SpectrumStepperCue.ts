...
export class SpectrumStepperCue implements IAudioCue {
  ...
  cueType = BuiltInAudioCues.SpectrumStepper
  description =
    'Sequentially steps through the rig on every beat, scaling brightness by average spectrum energy. Uses cyan and blue.'
