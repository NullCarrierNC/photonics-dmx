...
const defaultGroup: ICueGroup = {
  id: 'default',
  name: 'YARG Base Cues',
  description: 'A default set of YARG cues largely inspired by, but not matching, the original Stage Kit. If other groups don\'t define a cue, this group\'s cue will be used.',
  cues: new Map([
