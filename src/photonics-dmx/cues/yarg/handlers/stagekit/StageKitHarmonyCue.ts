...
import { getEffectClockwiseRotation } from '../../../../effects'
...
export class StageKitHarmonyCue implements INetCue {
  ...
  description =
    'Small venue: Green/blue clockwise chase on beat (= high cyan). Large venue: Yellow/red dual rotation patterns with 3-step and 4-step offsets (= additive blending).'
