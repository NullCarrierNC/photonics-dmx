...
export class StageKitDefaultCue implements INetCue {
  ...
  description =
    'Large venue: Blue/red alternating on keyframes, small venue: Red/blue alternating on keyframes and yellow lights normally ON but flash OFF on red drum.'
  ...
  private async executeLargeVenueDefault(
  ...
  private executeSmallVenueDefault(
    controller: ILightingController,
    lightManager: DmxLightManager,
  ): void {
