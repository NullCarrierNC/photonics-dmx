 ...
 */
export class StageKitWarmAutoCue implements INetCue {
  id = 'stagekit-warmAuto'
  cueId = CueType.Warm_Automatic
  description =
    '2x red, 1x yellow. Red animating clockwise, yellow animating counter-clockwise, on beat.'
  ...
  async execute(
    ...
    if (this.isFirstExecution) {
      ...
      sequencer.setEffect('warm-auto-red', redEffect)
