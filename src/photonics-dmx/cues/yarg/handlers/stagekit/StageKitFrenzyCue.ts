...
export class StageKitFrenzyCue implements INetCue {
  ...
  description =
    "Large venue: Red->Blue->Yellow cycle with 25% beat delays. Small venue: Red->Green->Blue cycle with 25% beat delays. NOTE: Differs from StageKit/YALCY as they change LEDs at different times, but this doesn't map well to a lower number of lights."
