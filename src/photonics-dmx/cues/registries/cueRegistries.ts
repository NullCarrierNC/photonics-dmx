...
import type { NetCueMode } from '../types/nodeCueTypes'

/**
 * One cue registry per net domain. Each domain keeps its own instance so its enabled groups,
 ...
 */
const instances = new Map<NetCueMode, CueRegistry>()

export function getCueRegistry(domain: NetCueMode = 'yarg'): CueRegistry {
