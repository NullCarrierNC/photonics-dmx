...
describe('SystemEffectsController', () => {
  ...
  beforeEach(() => {
    ...
    systemEffectsController = new SystemEffectsController(lightTransitionController, layerManager)
  ...
  describe('blackout', () => {
    it('should set blackout transitions for all lights', async () => {
      ...
      ;(systemEffectsController as any).getLights = jest
        .fn()
        .mockReturnValue([movingHeadLight, rgbLight])
