...
describe('Sequencer', () => {
  ...
  describe('setEffect', () => {
    it('should delegate to EffectManager.setEffect', async () => {
      // Setup spy on internal EffectManager
      const setEffectSpy = jest
        .spyOn((sequencer as any).effectManager, 'setEffect')
  ...
  describe('blackout', () => {
    it('should delegate to SystemEffectsController.blackout', async () => {
      ...
      const blackoutSpy = jest
        .spyOn((sequencer as any).systemEffectsController, 'blackout')
        .mockResolvedValue(undefined)
  ...
  describe('cancelBlackout', () => {
    it('should delegate to SystemEffectsController.cancelBlackout', () => {
      // Setup spy on internal SystemEffectsController
      const cancelBlackoutSpy = jest.spyOn(
        (sequencer as any).systemEffectsController,
        'cancelBlackout',
      )
