  ...
  beforeEach(() => {
    ...
    defaultGroup = {
      ...
      cues: new Map([
        ...
        [
          CueType.Chorus,
          new MockCueImplementation('default-chorus', 'Default chorus effect with color changes'),
        ],
      ]),
    }
    ...
    customGroup = {
      ...
      cues: new Map([
        [
          CueType.Chorus,
          new MockCueImplementation('custom-chorus', 'Custom chorus with blue effects'),
        ],
        [
          CueType.Verse,
          new MockCueImplementation('custom-verse', 'Custom verse with green effects'),
        ],
      ]),
    }
