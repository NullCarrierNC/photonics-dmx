...
const LightsLayoutIntro: React.FC<LightsLayoutIntroProps> = ({ headerRight }) => (
  <>
    ...
    <p className="mb-6 italic font-bold text-orange-400 text-[9pt]">
      YARG &amp RB3 can scale from 2 lights up, but we recommend and have tested mostly 4 and 8
      light configurations. A minimum of 4 lights is recommended.
    </p>
    <p className="mb-1 italic font-bold text-orange-400 text-[9pt]">
      In the legacy Direct Processing mode, RB3 requires either 4 or 8 lights in your layout. This
      mode is disabled by default. If you have &gt; 4 but &lt; 8, only the first 4 lights will be
      used.
    </p>
