...
interface CueSimulationActionsProps {
  ...
  /** RB3 cue mode has no beat/measure/keyframe song events — hide those buttons when false. */
  showSongSimulation?: boolean
}

/**
 * Row of simulation action buttons (Start Test, Stop, and — outside RB3 mode — Simulate
 * Beat/Measure/Keyframe).
 */
