    ...
    <div className="p-6">
      ...
      <div className="flex flex-col">
        <p className="mb-4 text-sm text-gray-600 dark:text-gray-400">
          Photonics is a DMX sequencer for YARG, Rock Band 3 Enhanced, and music visualization. It
          uses the light show data provided by the game, or audio analysis to select and configure
          different lighting effects that are output to DMX lighting fixtures.
        </p>

        <h2 className="text-xl font-bold mb-4 mt-4 text-orange-400">Development Status</h2>
        <p className="mb-4 text-orange-400">
          Photonics is still in its Alpha stages, and as such changes should be expected. We'd
        ...
        <p className="text-sm text-gray-600 dark:text-gray-400">
          For more information or to see the Quickstart Guide please visit us at{' '}
          <a
        ...
        <p className="mb-4 text-sm text-gray-600 dark:text-gray-400">
          A thank you to the developers of{' '}
          <a
            href="https://yarg.in/"
            target="_blank"
            className="text-blue-600 dark:text-blue-500 hover:underline">
          ...
          for building the future of rhythm gaming and The Fat Bastid /{' '}
          <a
            href="https://github.com/YARC-Official/YALCY"
            target="_blank"
            className="text-blue-600 dark:text-blue-500 hover:underline">
            YALCY
          </a>{' '}
          specifically for making the YARG lighting integration possible.
        </p>

        <p className="mb-8 text-sm text-gray-600 dark:text-gray-400">
          And a thank you to the developers of of{' '}
          <a
            href="https://rb3e.rbenhanced.rocks/"
            target="_blank"
            className="text-blue-600 dark:text-blue-500 hover:underline">
            RB3Enhanced
          </a>{' '}
          which makes Rock Band 3 support possible.
        </p>

        <p className="text-sm text-gray-600 dark:text-gray-400">
          Additional thanks to the creators of various libraries Photonics utilizes under the hood
          including:
        </p>
        <ul className="space-y-1 ml-4 mr-4">
          <li className="text-left text-sm text-gray-600 dark:text-gray-400">
            <a
              href="https://github.com/node-dmx/sacn"
              target="_blank"
              className="text-blue-600 dark:text-blue-500 hover:underline">
              sacn
            </a>
            : sACN DMX over network
          </li>
          <li className="text-left text-sm text-gray-600 dark:text-gray-400">
            <a
              href="https://github.com/node-dmx/dmx-ts"
              target="_blank"
              className="text-blue-600 dark:text-blue-500 hover:underline">
              dmx-ts
            </a>
