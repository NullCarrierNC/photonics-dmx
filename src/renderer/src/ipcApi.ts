...
// Test effects
export const startTestEffect = (effectId: string) => 
  window.electron.ipcRenderer.send('start-test-effect', effectId);

export const stopTestEffect = () => 
  window.electron.ipcRenderer.send('stop-test-effect');
