  ...
  return (
    <FlowNodeFrame
      ...
      <div className="text-[11px] opacity-90">
        Wait for: <span style={FONT_COURIER_NEW}>{waitFor}</span>
      </div>
      <div className="font-semibold text-sm text-center">
        ...
        {layerValue != null ? (
          <>
            {' '}
            (Layer: <span style={FONT_COURIER_NEW}>{layerValue}</span>)
          </>
        ) : null}
        {colorVarName ? (
          <>
            {' '}
            (<span style={FONT_COURIER_NEW}>{colorVarName}</span>)
          </>
        ) : null}
      </div>
      <div className="text-[11px] opacity-90 text-center">
        <span style={FONT_COURIER_NEW}>
