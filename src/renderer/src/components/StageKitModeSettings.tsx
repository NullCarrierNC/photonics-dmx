    ...
    <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6">
      ...
      <div className="mb-8">
        ...
        <p className="text-sm text-gray-600 dark:text-gray-400 mb-2">
          Stage Kit mode re-creates the original Rock Band Stage Kit lighting effects mapped to your
          DMX lights. It gives the most authentic RB3 style experience, but doesn't take advantange
          of the full capabilities of DMX lighting and animations.
        </p>
        <p className="text-sm text-gray-600 dark:text-gray-400 mb-2">
          If you select <em>Prefer for Tracked</em> then Photonics will only use the Stage Kit cues
          if the song has tracked lighting data.
        </p>
        <p className="text-sm text-gray-600 dark:text-gray-400 mb-4">
          If you select <em>Random</em> then Photonics will randomly choose from the enabled cue
          groups. To maintain a consistent visual experience, Photonics will only change a specific
          cue implementation after the cue consistency window has passed.
        </p>

        <div className="space-y-3">
          <div>
            <label
              htmlFor="stagekit-priority"
      ...
      <div>
        ...
        <div className=" ">
          ...
          <p className="text-sm text-gray-600 dark:text-gray-400 mb-4">
            If you have 8 lights then each of the 8 LED positions will be mapped to a single DMX
            light (1-8). If two or more colours are set to the same LED position then the resulting
            colour and brightness will be a blend of the LED values assigned to that position. E.g.
            Green and Blue on LED's 1 with result in Cyan on DMX light 1.
          </p>
          <p className="text-sm text-gray-600 dark:text-gray-400">
            If you have 4 lights then the Stage Kit LED colours assigned to lights 5-8 will be
            mapped 5-&gt;1, 6-&gt;2, 7-&gt;3, 8-&gt;4. The resulting colour and brightness will be a
            blend of the LED values assigned to 1 and 5, 2 and 6, etc. This means effects set to
            LEDs 1-4 and 5-8 will get blended together on DMX lights 1-4.
          </p>
        </div>
      </div>
    </div>
